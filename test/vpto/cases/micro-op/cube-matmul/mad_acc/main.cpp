...
void LaunchMad_acc_kernel(__fp16 *a, __fp16 *b, __fp16 *a_acc,
                          __fp16 *b_acc, float *c, void *stream);
...
int main() {
  ...
  FILE_CHECK(ReadFile("./v2.bin", inputSize, bHost, bSize) && inputSize == bSize,
             "./v2.bin");
  inputSize = aSize;
  FILE_CHECK(ReadFile("./v4.bin", inputSize, aAccHost, aSize) && inputSize == aSize,
             "./v4.bin");
  inputSize = bSize;
  FILE_CHECK(ReadFile("./v5.bin", inputSize, bAccHost, bSize) && inputSize == bSize,
             "./v5.bin");
  inputSize = cSize;
